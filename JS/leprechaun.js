class Leprechaun {
  ...
  didSteal(humans) {
    ...
    const crossLeft =
      humanLeft <= leprechaunRight && humanLeft >= leprechaunLeft;
    const crossRight =
      humanRight >= leprechaunLeft && humanRight <= leprechaunRight;
    const crossBottom =
      humanBottom >= leprechaunTop && humanBottom <= leprechaunBottom;
  ...
  gaveLuck(clovers) {
    ...
    const cloverLeft = clovers.x;
    const cloverRight = clovers.x + this.size;
    const cloverTop = clovers.y;
    const cloverBottom = clovers.y + this.size;

    const crossLeft =
      cloverLeft <= leprechaunRight && cloverLeft >= leprechaunLeft;
    const crossRight =
      cloverRight >= leprechaunLeft && cloverRight <= leprechaunRight;
    const crossBottom =
      cloverBottom >= leprechaunTop && cloverBottom <= leprechaunBottom;
    const crossTop = cloverTop >= leprechaunBottom && cloverTop <= leprechaunTop;
